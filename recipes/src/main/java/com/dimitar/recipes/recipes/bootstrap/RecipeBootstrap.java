package com.dimitar.recipes.recipes.bootstrap;

import com.dimitar.recipes.recipes.entities.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        final Ingredient ingredientDummy = new Ingredient();
        ingredientDummy.setDescription("Dummy desc");
        ingredientDummy.setUom(tableSpoonUom);
        ingredientDummy.setAmount(BigDecimal.TEN);
        ingredientDummy.setRecipe(tacosRecipe);
        tacosRecipe.getIngredients().add(ingredientDummy);
